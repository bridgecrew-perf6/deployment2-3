                    ...
                    <div class="page-header">
                        ...
                        <div class="header-sub-title">
                            <nav class="breadcrumb breadcrumb-dash">
                                ...
                                <a class="breadcrumb-item" href="{{url()->previous()}}">Capa</a>
                                <span class="breadcrumb-item active">Editar Capa</span>
                            </nav>
                        </div>
                    </div>
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{url('capas/'.$capa->idLayer)}}" method="POST">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="c"><sup class="obligatorio">*</sup>Capa</label>
                                        <input type="text" class="form-control" name="c" id="c"
                                               placeholder="Desarrollador" value="{{$capa->layer}}">
