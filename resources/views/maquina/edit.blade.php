    ...
    <div class="page-header">
        ...
        <div class="header-sub-title">
            <nav class="breadcrumb breadcrumb-dash">
                ...
                <span class="breadcrumb-item active">Actualizar Maquina</span>
            </nav>
        </div>
    </div>
    <div class="card">
        <div class="card-body">
 <h2>Actualizar maquina</h2>
            <br>
            <form  method="post" action="{{url('crearma/'.$maquina->id_maq)}}">
           @csrf

    <div class="form-row">
        <div class="form-group col-md-6">
            <label for="inputEmail4">Nombre de la Maquina</label>
            <input type="text" class="form-control" id="maquina" name="maquina" value="{{$maquina->nomb_maq}}" placeholder="Maquina">
        </div>
        <div class="form-group col-md-6">
            <label for="inputPassword4">Ram</label>
            <input type="text" class="form-control" id="ram" name="ram" value="{{$maquina->ram}}" placeholder="Ram">
        </div>
    </div>
    <div class="form-row">
     <div class="form-group col-md-6">
        <label for="inputAddress">Fecha de creación</label>
        <input type="date" class="form-control" id="fech" name="fech" value="{{$maquina->f_maq}}">
        </div>
        <div class="form-group col-md-6">
        @foreach ($u as $un)
            <label for="inputPassword4"></label>
            <input type="hidden" class="form-control" id="idfk" name="idfk" placeholder="idkf" value ="{{$un->idUsuario}}">
            @endforeach
        </div>
    </div>
    <div class="form-row">
        <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" id="red" name="red" value="{{$maquina->u_red}}">
        </div>
